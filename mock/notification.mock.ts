...
export default defineMock([
  {
    url: "notify-messages",
    method: ["GET"],
    body: { code: "SUCCESS", data: { list: mockMessages, total: mockMessages.length }, message: "ok" },
  },
  {
    url: "notify-messages/:id",
    method: ["GET"],
    body: { code: "SUCCESS", data: mockMessages[0], message: "ok" },
  },
  {
    url: "notify-messages",
    method: ["POST"],
  ...
  },
  {
    url: "notify-records",
    method: ["GET"],
    body: { code: "SUCCESS", data: { list: mockInbox, total: mockInbox.length }, message: "ok" },
  },
  {
  ...
  },
  {
    ...
    method: ["GET"],
    body: { code: "SUCCESS", data: { list: mockTemplates, total: mockTemplates.length }, message: "ok" },
  },
  {
    url: "notify-templates/:id",
    method: ["GET"],
    body: { code: "SUCCESS", data: mockTemplates[0], message: "ok" },
  },
  {
    url: "notify-templates",
    method: ["POST"],
