...
export default defineMock([
  ...
  },
  {
    ...
    method: ["GET"],
    body: { code: 200, data: { authorize_url: "https://example.com/oauth/authorize" }, msg: "ok" },
  },
  {
  ...
  { url: "auth/register", method: ["POST"], body: { code: 200, data: {}, msg: "ok" } },
  { url: "auth/password-resets", method: ["POST"], body: { code: 200, data: {}, msg: "ok" } },
  {
