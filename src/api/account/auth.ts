...
export const AuthAPI = {
  ...
  getCaptcha(params?: GetCaptchaReq): Promise<ApiResponse<GetCaptchaResp>> {
    return request({
      url: `/admin-api/v1/auth/captchas`,
      method: "GET",
      params: params,
    });
  },
  ...
  sendEmailCode(data?: SendEmailCodeReq): Promise<ApiResponse<SendEmailCodeResp>> {
    return request({
      url: `/admin-api/v1/auth/email-verification-codes`,
      method: "POST",
      data: data,
    });
  },
  ...
  emailLogin(data?: EmailLoginReq): Promise<ApiResponse<LoginResp>> {
    return request({
      url: `/admin-api/v1/auth/login-by-email`,
      method: "POST",
      data: data,
    });
  },
  ...
  mobileLogin(data?: MobileLoginReq): Promise<ApiResponse<LoginResp>> {
    return request({
      url: `/admin-api/v1/auth/login-by-mobile`,
      method: "POST",
      data: data,
    });
  },
  ...
  passwordLogin(data?: PasswordLoginReq): Promise<ApiResponse<LoginResp>> {
    return request({
      url: `/admin-api/v1/auth/login-by-password`,
      method: "POST",
      data: data,
    });
  },
  ...
  sendMobileCode(data?: SendMobileCodeReq): Promise<ApiResponse<SendMobileCodeResp>> {
    return request({
      url: `/admin-api/v1/auth/mobile-verification-codes`,
      method: "POST",
      data: data,
    });
  },
  ...
  resetPassword(data?: ResetPasswordReq): Promise<ApiResponse<ResetPasswordResp>> {
    return request({
      url: `/admin-api/v1/auth/password-resets`,
      method: "POST",
      data: data,
    });
  },
